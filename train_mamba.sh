...
#SBATCH --output=/group/jug/aman/MambaSplit_Runs/mamba_finetune/logs/%x_%j.log
#SBATCH --error=/group/jug/aman/MambaSplit_Runs/mamba_finetune/logs/%x_%j.err
...
#SBATCH --job-name=mamba-finetune-ddp
...
export EXP_NAME="mamba_finetune_$(date +%Y%m%d_%H%M%S)"
export LOGDIR="/group/jug/aman/MambaSplit_Runs/mamba_finetune/logs/${EXP_NAME}"
export CHECKPOINTDIR="/group/jug/aman/MambaSplit_Runs/mamba_finetune/checkpoints/${EXP_NAME}"
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

# Create output directories
mkdir -p "${LOGDIR}"
mkdir -p "${CHECKPOINTDIR}"
mkdir -p "/group/jug/aman/MambaSplit_Runs/mamba_finetune/outputs/${EXP_NAME}"

echo "================================================================"
echo "Mamba Encoder Training"
echo "================================================================"
